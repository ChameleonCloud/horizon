...
class VirtualInstances(Instances):
    """CHI: the instances panel again, under the "Virtual Compute" group.

    Reuses every view, table and action from Instances; only the index view is
    routed here, per vm_urls.py. A distinct slug is required rather than
