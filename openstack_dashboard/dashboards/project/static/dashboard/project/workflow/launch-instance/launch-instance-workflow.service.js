...
(function () {
  ...
  function launchInstanceWorkflow(basePath, stepPolicy, dashboardWorkflow) {
    ...
    /**
     * @name createWorkflow
     * @param {string} instanceType Which launch button opened the wizard.
     * @description
     * Built each time the modal is opened. A shared workflow object would carry
     * one launch's instance type into the next.
